    ...
    <div className="space-y-3">
      ...
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <p className="mb-2 text-[12px] font-medium uppercase tracking-wider text-text-light">
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-1.5">
          {season.themes.map((theme, i) => (
            <span
              key={i}
              className="rounded-full bg-sage/10 px-2.5 py-0.5 text-[12px] text-sage"
            >
              {theme}
            </span>
          ))}
      ...
      <p className="text-[12px] italic text-text-light">
