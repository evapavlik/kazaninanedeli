    ...
    <div className="space-y-4">
      ...
      {commentaryUrl && (
        <a
          ...
          className="flex items-center gap-3 rounded-lg border border-sage/20 bg-white/70 px-3.5 py-3 transition-all hover:border-sage/40 hover:bg-white"
        >
          <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-md bg-sage/10">
            <svg width="18" height="18" viewBox="0 0 20 20" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-sage">
